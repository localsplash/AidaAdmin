...
| `/did-routes`                                     | GET        | `/dids?iTenantId=N&authorizedDid=...` for current Identity tenant Numbers |
| `/did-routes/:did`                                | PUT/DELETE | `/dids/:did?iTenantId=N&authorizedDid=...` after rechecking Identity      |
